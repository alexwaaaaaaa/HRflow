...
import { Download, Filter, Calendar, TrendingUp, Users, Clock, Star } from "lucide-react";
...
export default function OnboardingReports() {
    return (
        <Page
            ...
            subtitle="Measure the effectiveness and ROI of your onboarding programs."
            breadcrumbs={[
                { label: "Home", href: "/" },
                { label: "Onboarding", href: "/onboarding/dashboard" },
                { label: "Reports", href: "/onboarding/reports" },
            ]}
            maxWidth="1600px"
            actions={
                <>
                    <div className="bg-[#1A2A3A] border border-[#2A3A4A] rounded-lg px-4 py-2 flex items-center gap-2 text-sm text-[#8899AA]">
                        <Calendar size={16} aria-hidden="true" /> Q1 2026 (Jan - Mar)
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <Card padding="lg">
                        <div className="flex justify-between items-start mb-4">
                            ...
                            <span className="flex items-center gap-1 text-xs font-bold text-[#00E5A0] bg-[#00E5A0]/10 px-2 py-1 rounded-full">
                    ...
                    <Card padding="lg">
                        <div className="flex justify-between items-start mb-4">
                            ...
                            <span className="flex items-center gap-1 text-xs font-bold text-[#00E5A0] bg-[#00E5A0]/10 px-2 py-1 rounded-full">
                                <TrendingUp size={12} aria-hidden="true" /> 0.3
                            </span>
                        </div>
                    ...
                    <Card padding="lg">
                        <div className="flex justify-between items-start mb-4">
                            ...
                            <span className="flex items-center gap-1 text-xs font-bold text-[#00E5A0] bg-[#00E5A0]/10 px-2 py-1 rounded-full">
                                <TrendingUp size={12} aria-hidden="true" /> 2%
                            </span>
                        </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <Card padding="lg" className="lg:col-span-2">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <button type="button" className="text-sm font-semibold text-[#00E5A0] hover:underline">
                                View All Feedback
                            </button>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="p-5 border border-[#1A2A3A] rounded-xl bg-[#0A1420]">
                                <div className="flex text-[#FFB020] mb-3" aria-label="5 out of 5 stars">
                                    {[1, 2, 3, 4, 5].map((n) => (
                                        <Star key={n} size={16} fill="currentColor" aria-hidden="true" />
                                    ))}
                                </div>
                                <p className="text-sm text-[#8899AA] italic mb-4">
                                    &quot;The pre-boarding portal was amazing. I knew exactly where to go and what to do on Day 1. My buddy Vikram was incredibly helpful!&quot;
                                </p>
                                <div className="flex items-center gap-2">
                                    <div className="w-6 h-6 rounded-full bg-[#1A2A3A] text-xs flex items-center justify-center font-bold text-white" aria-hidden="true">SR</div>
                                    <span className="text-xs text-[#8899AA] font-semibold">Sneha R. • Product Design</span>
                                </div>
                            </div>

                            <div className="p-5 border border-[#1A2A3A] rounded-xl bg-[#0A1420]">
                                <div className="flex text-[#FFB020] mb-3" aria-label="4 out of 5 stars">
                                    {[1, 2, 3, 4].map((n) => (
                                        <Star key={n} size={16} fill="currentColor" aria-hidden="true" />
                                    ))}
                                    <Star size={16} className="text-[#445566]" aria-hidden="true" />
                                </div>
                                <p className="text-sm text-[#8899AA] italic mb-4">
                                    &quot;Great induction sessions. However, my software access to Jira took 2 days to process which delayed my learning.&quot;
                                </p>
                                <div className="flex items-center gap-2">
                                    <div className="w-6 h-6 rounded-full bg-[#1A2A3A] text-xs flex items-center justify-center font-bold text-white" aria-hidden="true">AM</div>
                            ...
                            <div className="p-5 border border-[#2A3A4A] rounded-xl bg-gradient-to-br from-[#1A2A3A] to-[#0A1420]">
                                ...
                                <p className="text-sm text-[#8899AA] mb-4">
                                    Sentiment analysis indicates that{" "}
                                    <strong className="text-[#FF4444]">Software Provisioning Speed</strong> is the most common pain point mentioned in the last 30 days.
                                </p>
                                <Button variant="secondary" className="w-full justify-center">
                                    Take Action via Helpdesk
                                </Button>
                            </div>
                        </div>
                    </Card>
