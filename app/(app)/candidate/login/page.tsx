    ...
    return (
        <div className="min-h-screen bg-[#0A1420] flex">
            ...
            <div className="hidden lg:flex flex-1 bg-indigo-600/10 border-r border-[#1A2A3A] relative overflow-hidden flex-col justify-between p-12">
                <div className="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] bg-indigo-500/20 blur-[120px] rounded-full pointer-events-none" />
            ...
            <div className="flex-1 flex flex-col justify-center items-center p-6 relative">
                <div className="w-full max-w-md space-y-8 relative z-10">
                    ...
                    <div className="space-y-4">
                        <button className="w-full bg-[#131B2B] hover:bg-[#1A2A3A] border border-[#2A3A4A] text-white font-bold py-3 rounded-xl transition-colors flex items-center justify-center gap-3">
                    ...
                    <form className="space-y-4">
                        <div>
                            <label className="block text-[#8899AA] text-xs font-bold mb-2">Email Address</label>
                            <input type="email" placeholder="jane@example.com" className="w-full bg-[#131B2B] border border-[#2A3A4A] rounded-xl px-4 py-3 text-white focus:border-indigo-500 outline-none transition-colors" />
                        </div>
