...
export default function SalaryRevisionsHistory() {
  return (
    <Page
      ...
      breadcrumbs={[{ label: "Employees", href: "/employees" }, { label: "Salary Revisions" }]}
      maxWidth="1200px"
    >
        ...
        >
          <div>
            ...
            <div style={{ fontSize: 13, color: "#8899AA" }}>
              Track all compensation changes and approvals
            </div>
          </div>
        ...
        >
          {[
            ...
            >
              ...
              <div
                style={{ fontSize: 24, fontWeight: 700, color: c.green ? "#00E5A0" : "#FFFFFF" }}
              >
                {c.val}
              </div>
            </div>
        ...
        <div style={{ padding: "0 32px" }}>
          ...
          >
            <div
              style={{
                display: "grid",
                gridTemplateColumns: "200px 100px 100px 100px 80px 100px 140px 100px 90px 40px",
                padding: "12px 20px",
                background: "#0A1420",
            ...
            {REVISIONS.map((row, i) => (
              <div
                ...
                style={{
                  ...
                  gridTemplateColumns: "200px 100px 100px 100px 80px 100px 140px 100px 90px 40px",
                  padding: "12px 20px",
                  borderBottom: i < REVISIONS.length - 1 ? "1px solid #1A2A3A" : "none",
                  alignItems: "center",
                }}
                className="transition-colors hover:bg-[#1A2A3A]"
              >
                ...
                <div style={{ fontSize: 13, color: "#8899AA" }}>
                  ₹{(row.oldCtc / 100000).toFixed(1)}L
                </div>
                <div style={{ fontSize: 13, color: "#FFFFFF", fontWeight: 600 }}>
                  ₹{(row.newCtc / 100000).toFixed(1)}L
                </div>
                <div
                  style={{
                    fontSize: 13,
                    color: row.pct > 0 ? "#00E5A0" : "#8899AA",
                    fontWeight: 600,
                  }}
                >
                  {row.pct > 0 ? `+${row.pct}%` : "—"}
                ...
                <div>
                  <span
                    style={{
                      fontSize: 11,
                      background:
                        row.status === "Approved" ? "rgba(0,229,160,0.1)" : "rgba(255,184,0,0.1)",
                      color: row.status === "Approved" ? "#00E5A0" : "#FFB800",
                      padding: "4px 8px",
                      borderRadius: 20,
                      fontWeight: 500,
                    }}
                ...
                <div style={{ textAlign: "right" }}>
                  <Link
                    href={`/employees/${row.empId}/salary-revision`}
                    style={{ color: "#445566" }}
