  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div>
            ...
            <div style={{ fontSize: 14, color: "#8899AA" }}>
              File: HR_Data_Dump_Nov2024.xlsx{" "}
              <span style={{ color: "#445566", marginLeft: 8 }}>(124 rows, 22 columns)</span>
            </div>
          </div>
            ...
            {columns.map((col, i) => (
              <div
                ...
                style={{
                  ...
                  alignItems: "center",
                  background: col.ignore ? "rgba(255,255,255,0.02)" : "transparent",
                  opacity: col.ignore ? 0.5 : 1,
                }}
              >
                ...
                <div>
                  <select
                    style={{
                      width: "100%",
                      height: 36,
                      background: col.status === "mapped" ? "rgba(0,102,255,0.1)" : "#0A1420",
                      border:
                        col.status === "mapped"
                      ...
                      borderRadius: 8,
                      padding: "0 12px",
                      color: col.status === "mapped" ? "#0066FF" : "#8899AA",
                      fontSize: 13,
                      fontWeight: col.status === "mapped" ? 600 : 400,
                      appearance: "none",
                      cursor: "pointer",
                    }}
                    id="page-74"
        ...
        >
          <div>
            <h4 style={{ fontSize: 14, fontWeight: 600, color: "#FFFFFF", margin: "0 0 4px 0" }}>
              Auto-mapping complete!
            </h4>
            <p style={{ fontSize: 13, color: "#8899AA", margin: 0 }}>
              We successfully mapped 20 of 22 columns automatically.
            </p>
          </div>
          <div style={{ fontSize: 13, color: "#8899AA" }}>
            <span style={{ color: "#FFB800", fontWeight: 600 }}>1</span> unmapped ·{" "}
            <span style={{ color: "#445566", fontWeight: 600 }}>1</span> ignored
          </div>
        </div>
      </div>
    </Page>
