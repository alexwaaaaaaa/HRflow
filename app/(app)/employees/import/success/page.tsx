        ...
        >
          ...
          <div
            style={{
              ...
              width: 300,
              height: 300,
              background: "radial-gradient(circle, rgba(0,229,160,0.15) 0%, rgba(0,229,160,0) 70%)",
            }}
          />
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <h1 style={{ fontSize: 32, fontWeight: 700, color: "#FFFFFF", margin: "0 0 16px 0" }}>
              Import Successful!
            </h1>
            <p style={{ fontSize: 16, color: "#8899AA", margin: "0 0 32px 0", lineHeight: 1.5 }}>
              Successfully imported <strong style={{ color: "#FFFFFF" }}>123 employees</strong> into
              HRFlow.
              <br />1 row was skipped due to validation errors.
            </p>
            ...
            >
              <div>
                ...
                <div style={{ fontSize: 12, color: "#8899AA" }}>
                  Contains the 1 skipped row with error details.
                </div>
              </div>
