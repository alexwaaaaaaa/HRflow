...
export default function BulkImport() {
  ...
  return (
    <Page
      ...
      subtitle="156 employees imported successfully into HRFlow."
      breadcrumbs={[{ label: "Employees", href: "/employees" }, { label: "Import" }]}
      maxWidth="1200px"
    >
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "32px 32px 80px" }}>
        <div style={{ marginBottom: 32 }}>
          <Link
            href="/employees"
            style={{ color: "#8899AA", textDecoration: "none", fontSize: 13 }}
          >
            ← Back to Employees
          </Link>
          <h1 style={{ fontSize: 24, fontWeight: 700, color: "#FFFFFF", marginTop: 12 }}>
            Bulk Import Employees
          </h1>
          <div style={{ fontSize: 14, color: "#8899AA", marginTop: 4 }}>
            Import multiple employees via Excel or CSV
          </div>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 32 }}>
          {[
            ...
            <div key={s.num} style={{ display: "flex", alignItems: "center", gap: 16 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <div
                  style={{
                    ...
                    borderRadius: "50%",
                    background:
                      step > s.num ? "#00E5A0" : step === s.num ? "rgba(0,229,160,0.2)" : "#1A2A3A",
                    border: step === s.num ? "1px solid #00E5A0" : "none",
                    color: step > s.num ? "#060B14" : step === s.num ? "#00E5A0" : "#445566",
                    display: "flex",
                    alignItems: "center",
                ...
                <span
                  style={{
                    ...
                    color: step >= s.num ? "#FFFFFF" : "#445566",
                  }}
                >
                  {s.label}
                </span>
              ...
              {i < 3 && (
                <div
                  style={{ width: 40, height: 2, background: step > s.num ? "#00E5A0" : "#1A2A3A" }}
                />
              )}
            </div>
          ))}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 400px", gap: 32 }}>
            <div>
              <div style={{ display: "flex", gap: 16, marginBottom: 24 }}>
                {["Basic Template (30 cols)", "Full Template (80 cols)", "Keka/Darwinbox Sync"].map(
                  (t) => (
                    <div
                      key={t}
                      style={{
                      ...
                      className="transition-colors hover:border-[#00E5A0]"
                    >
                      <FileSpreadsheet size={24} color="#00E5A0" style={{ marginBottom: 12 }} />
                      <div
                        style={{ fontSize: 13, fontWeight: 600, color: "#FFFFFF", marginBottom: 4 }}
                      >
                        {t}
                      </div>
                      <div
              ...
              <div
                ...
                style={{
                  ...
                  padding: "60px 20px",
                  textAlign: "center",
                  background: dragging ? "rgba(0,229,160,0.02)" : "transparent",
                  cursor: "pointer",
                  transition: "all 0.2s",
                }}
              >
                {!file ? (
                  <>
                    <UploadCloud
                      size={40}
                      color={dragging ? "#00E5A0" : "#445566"}
                      style={{ margin: "0 auto 16px" }}
                    />
                    <div
                      style={{ fontSize: 16, fontWeight: 600, color: "#FFFFFF", marginBottom: 8 }}
                    >
                      {dragging ? "Drop file here" : "Drag & drop your Excel / CSV file"}
                    </div>
                    <div style={{ fontSize: 13, color: "#8899AA" }}>
                      Supported: .xlsx, .csv • Max 10MB • Up to 10,000 employees
                    </div>
            ...
            <div>
              ...
              >
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                  {[
                    "Download template before uploading",
                    "First row must be column headers",
                    "Date format: DD/MM/YYYY",
                    "IDs auto-generated if blank",
                  ].map((g) => (
            ...
            >
              <div>
                ...
                <span style={{ color: "#8899AA", fontSize: 14 }}>
                  • 32 cols mapped, 0 unmapped required
                </span>
              </div>
        ...
        {step === 3 && (
          <div>
            ...
            >
              <div style={{ display: "flex", gap: 24 }}>
                <div style={{ color: "#FFFFFF" }}>
                  <span style={{ fontSize: 20, fontWeight: 700 }}>156</span> Total
                </div>
                <div style={{ color: "#00E5A0" }}>
                  <span style={{ fontSize: 20, fontWeight: 700 }}>153</span> Valid
                </div>
                <div style={{ color: "#FFB800" }}>
                  <span style={{ fontSize: 20, fontWeight: 700 }}>3</span> Warnings
                </div>
                <div style={{ color: "#FF4444" }}>
                  <span style={{ fontSize: 20, fontWeight: 700 }}>0</span> Errors
                </div>
              </div>
            ...
            >
              ...
              <div>
                <div style={{ fontSize: 14, fontWeight: 600, color: "#FFB800" }}>
                  3 Designation warnings detected
                </div>
                <div style={{ fontSize: 13, color: "#8899AA", marginTop: 4 }}>
                  &quot;VP Marketing&quot; and &quot;Lead Designer&quot; do not exist in the system.
                  They will be auto-created during import.
                </div>
              </div>
            </div>
            ...
            >
              <DataTable
                ...
                rowKey={(r) => r.n}
                aria-label="Bulk Import Employees"
              />
            </div>
          </div>
        )}
        ...
        {step === 4 && (
          <div style={{ textAlign: "center", padding: "60px 0" }}>
            ...
            <p style={{ fontSize: 16, color: "#8899AA", marginBottom: 32 }}>
              156 employees imported successfully into HRFlow.
            </p>
