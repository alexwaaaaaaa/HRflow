...
import { TrendingUp, IndianRupee, BarChart2, ArrowRight, CheckCircle2 } from 'lucide-react';
...
export default function FBPDashboard() {
    return (
        <Page
            title="Flexible Benefit Plan (FBP)"
            subtitle="Employee-driven salary structuring to maximize take-home and minimize tax liability"
            breadcrumbs={[
                { label: "Home", href: "/" },
        ...
        >
            <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    ...
                    <Card padding="none" className="md:col-span-2 overflow-hidden">
