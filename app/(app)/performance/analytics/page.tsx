...
const TREND = [
    { year: "FY21", avg: 3.4 }, { year: "FY22", avg: 3.6 }, { year: "FY23", avg: 3.5 },
    { year: "FY24", avg: 3.75 }, { year: "FY25", avg: 3.85 },
];
        ...
        <div className="p-6 md:p-8 max-w-[1200px] mx-auto text-white">
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-sm text-[#8899AA]">Deep insights into organisation performance trends</p>
                </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                {[
                    { label: "Avg Org Rating", value: "3.85", sub: "+0.1 YoY", color: "#00E5A0", trend: "↑" },
                    { label: "Top Performers (E+EE)", value: "282", sub: "55% of org", color: "#0066FF", trend: "↑" },
                    { label: "PIP Cases", value: "4", sub: "0.8% of org", color: "#FF4444", trend: "↓" },
                    { label: "Promotions Approved", value: "18", sub: "3.5% rate", color: "#9B59B6", trend: "→" },
                ].map(k => (
                    <div key={k.label} className="bg-[#0D1928] border border-[#1A2A3A] rounded-2xl p-5">
                        ...
                        <p className="text-[11px]" style={{ color: k.color }}>{k.trend} {k.sub}</p>
                    </div>
                ))}
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div className="bg-[#0D1928] border border-[#1A2A3A] rounded-2xl p-6">
                    <h3 className="font-semibold mb-4">Department Avg Ratings</h3>
                            ...
                            <ChartWrapper height="h-[220px]">
                                <BarChart data={DEPT_RATINGS} barSize={30}>
                                    ...
                                    <Bar dataKey="avg" radius={[6, 6, 0, 0]}>
                                        {DEPT_RATINGS.map(d => <Cell key={d.dept} fill={d.avg >= 4 ? "#00E5A0" : "#0066FF"} />)}
                                    </Bar>
                                </BarChart>
                            </ChartWrapper>
                        </ChartWrapper>
                ...
                {/* Trend over years */}
                <div className="bg-[#0D1928] border border-[#1A2A3A] rounded-2xl p-6">
                    <h3 className="font-semibold mb-4">Rating Trend (5-Year)</h3>
                    <div className="h-[220px]">
                        <ChartWrapper>
                            <ChartWrapper height="h-[220px]">
            ...
            {/* Distribution pie */}
            <div className="bg-[#0D1928] border border-[#1A2A3A] rounded-2xl p-6">
                <h3 className="font-semibold mb-4">Rating Distribution Breakdown</h3>
