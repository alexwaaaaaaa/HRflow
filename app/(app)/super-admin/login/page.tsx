...
// Note: This is a full-screen auth page — no Page shell by design (same pattern as auth/* pages)
    ...
    <div className="min-h-screen bg-[#060D1A] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="w-16 h-16 bg-[#0A1420] rounded-2xl border border-[#1A2A3A] flex items-center justify-center mb-4">
            <Server size={32} className="text-white" aria-hidden="true" />
          </div>
        ...
        <div className="bg-[#0A1420]/80 backdrop-blur-xl border border-[#1A2A3A] rounded-3xl p-8 shadow-2xl relative overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-indigo-500 to-transparent opacity-50" aria-hidden="true" />
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="space-y-1">
                  <label htmlFor="admin-uid" className="text-[10px] uppercase font-bold text-[#8899AA] tracking-wider block">
                    Admin Identity ID
                  </label>
                  <div className="relative">
                    <Fingerprint size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-[#556677]" aria-hidden="true" />
                    <input
                      id="admin-uid"
                      type="text"
                      placeholder="Enter UID or Service Account"
                      defaultValue="sysadmin-root-01"
                      className="w-full bg-[#131B2B] border border-[#2A3A4A] rounded-xl py-3 pl-12 pr-4 text-white text-sm focus:border-indigo-500 outline-none transition-all placeholder:text-[#3A4A5A]"
                    />
                  </div>
                </div>

                <div className="space-y-1">
                  <label htmlFor="admin-password" className="text-[10px] uppercase font-bold text-[#8899AA] tracking-wider block">
                    Master Password
                  </label>
                  <div className="relative">
                    <Lock size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-[#556677]" aria-hidden="true" />
                    <input
                      id="admin-password"
                      type="password"
                      placeholder="••••••••••••••••"
              ...
              <Button
                ...
                className="w-full justify-center bg-white text-[#0A1420] hover:bg-gray-200 mt-4"
          ...
          {authStep === "otp" && (
            <div className="space-y-6">
              ...
              <fieldset>
                <legend className="sr-only">Enter 6-digit OTP code</legend>
              ...
              <Button variant="primary" className="w-full justify-center" onClick={() => setAuthStep("verify")}>
                Verify Token
              </Button>
              <Button variant="ghost" className="w-full justify-center text-xs" onClick={() => setAuthStep("credentials")}>
                ← Back to Login
              </Button>
            </div>
          )}
          ...
          {authStep === "verify" && (
            <div className="space-y-6 py-6 text-center flex flex-col items-center">
              <div
                className="w-16 h-16 rounded-full border-t-2 border-indigo-500 animate-spin mb-4"
                role="status"
                aria-label="Establishing root session"
              />
        ...
        {/* Warning Footer */}
        <div className="mt-8 flex items-start gap-3 bg-rose-500/5 border border-rose-500/20 p-4 rounded-xl" role="alert">
          <ShieldAlert size={20} className="text-rose-500 shrink-0 mt-0.5" aria-hidden="true" />
