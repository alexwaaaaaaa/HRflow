...
const variantMap: Record<BadgeVariant, string> = {
  ...
  warning: "bg-[rgba(245,158,11,0.12)] text-[#fbbf24] border border-[rgba(245,158,11,0.2)]",
  danger:  "bg-[rgba(239,68,68,0.15)]  text-[#fca5a5] border border-[rgba(239,68,68,0.25)]",
  info:    "bg-[rgba(59,130,246,0.12)]  text-[#60a5fa] border border-[rgba(59,130,246,0.2)]",
  purple:  "bg-[rgba(139,92,246,0.12)]  text-[#a78bfa] border border-[rgba(139,92,246,0.2)]",
  neutral: "bg-[rgba(255,255,255,0.06)] text-[#94a3b8] border border-[rgba(255,255,255,0.08)]",
